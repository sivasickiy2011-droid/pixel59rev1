# Рекомендации по функции: submit-order

## UUID
`/api/4dbcd084-f89e-4737-be41-9371059c6e4d`

## Описание функции
Обработка заявок с калькулятора услуг и отправка в Битрикс24 + Telegram.
...
2. Тест с различными типами заказов
